...
public final class FileSystemMetadataSyncV2BenchmarkTest extends FileSystemMasterTestBase {
  ...
  private static final String LOCAL_FS_ABSOLUTE_PATH = "/Users/yimin.wei/s3-test-filess/bucket";
  ...
  public void syncV2()
    ...
    // First pass
    SyncResult result =
        mFileSystemMaster.syncMetadataInternal(MOUNT_POINT, createContext(DescendantType.ALL));
